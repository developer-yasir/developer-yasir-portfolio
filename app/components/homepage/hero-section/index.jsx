        ...
        >
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <motion.div variants={itemVariants} className="flex items-center gap-6 pt-4 border-t border-white/10">
              <Link href={personalData.github} target="_blank" className="text-gray-400 hover:text-white transition-colors">
                <FaGithub size={28} />
              </Link>
              <Link href={personalData.linkedIn} target="_blank" className="text-gray-400 hover:text-emerald-400 transition-colors">
                <FaLinkedin size={28} />
              </Link>
            </motion.div>
          </div>
